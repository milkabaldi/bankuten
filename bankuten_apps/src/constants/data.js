...
const reviews = [
    {
        text: 'You have saved our business! Since I invested in Cornelia I made over 100,000 dollars profits. Thank you so much for your help',
        face: images.Rev1,
        name: "Peter Miguel",
        position: 'CEO @Combinator',
    },
    {
        text: 'Without Cornelia, we would have gone bankrupt by now',
        face: images.Rev2,
        name: "Sarah Ewing",
        position: 'Digital Manager @FullSocial',
    },
    {
        ...
        face: images.Rev3,
        name: "Larry Davis",
        position: 'Traffic Manager @Upside',
    },
    {
        text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque libero cras ',
        face: images.Rev4,
        name: "Linda R. Huff",
        position: 'Happiness Manager @BlueSky',
    },
    {
        text: "Cornelia did exactly what you said it does. I'd be lost without Cornelia. I just can't get enough of Cornelia. I want to get a T-Shirt with Cornelia on it so I can show it off to everyone. I would like to personally thank you for your outstanding product.",
        face: images.Rev5,
        name: "Debra Peters",
        position: 'Product Owner @Generate',
    },
    {
        text: "We can't understand how we've been living without Cornelia. We have no regrets! Since I invested in Cornelia I made over 100,000 dollars profits. Needless to say we are extremely satisfied with the results. Cornelia is the most valuable business resource we have EVER purchased. Definitely worth the investment. Not able to tell you how happy I am with Cornelia. I am so pleased with this product.'",
        name: "Valentine Sutton",
        position: 'Product Designer @Tools',
    },
    {
        text: 'We were treated like royalty',
        face: images.Rev7,
        name: "Vida Inman",
        position: 'Sales Manager @UShould',
    },
    {
        ...
        position: 'Photographer @Streetz',
    },
    {
        text: "Cornelia has got everything I need. Your company is truly upstanding and is behind its product 100%. I can't say enough about Cornelia. I'm good to go.",
        face: images.Rev9,
        name: "Helen Womack",
        position: 'CTO @Stoock',
    },
    {
        text: "I don't know what else to say. I made back the purchase price in just 48 hours! The service was excellent. Cornelia saved my business. I love Cornelia. We've seen amazing results already. Cornelia is the most valuable business resource we have EVER purchased. If you aren't sure, always go for Cornelia.",
        face: images.Rev10,
        name: "John Morgan",
        position: 'CEO @FunkyToys',
    }
]
